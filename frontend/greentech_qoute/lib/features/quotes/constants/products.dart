class Product {
  ...
  final bool hasActuator; // Add this explicit flag
  final bool hasFusibleLink;
  ...
  const Product({
    ...
    required this.model,
    this.description,
    this.materials = const ['AL', 'GI', 'IS'],
    this.unit = 'pcs',
    this.customizations = const [],
    this.basePrice = 500,
    this.multipliers = const {'AL': 6.5, 'GI': 6.5},
    this.roundPrices,
    this.hasActuator = false, // Default to false
    this.hasFusibleLink = false, // Default to false
...
const kProducts = [
  ...
  Product(
    ...
    Product(
    name: 'Fire Damper (Blade Type);E1120(2hrs);',
    model: 'S-FD-FS',
    materials: ['GI'],                   // ← GI only
    basePrice: 10600,
    multipliers: {'GI': 8.0},
    ...
    // ─── Insulation ─────────────────────────────────────────────
    Product(
    name: 'TROCELEN AIR PRO: CLASS-0 POLYOLEEFIN',
    model: 'TROCELEN',
    materials: ['IS'],                
    basePrice: 19500,
    multipliers: {'IS': 8.0},
