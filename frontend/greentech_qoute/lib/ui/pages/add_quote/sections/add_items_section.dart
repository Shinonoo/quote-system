...
class AddItemsSection extends StatelessWidget {
    ...
    return SectionCard(
      ...
      child: Column(
        children: [
          ...
          if (selectedProduct != null && selectedProduct.customizations.isNotEmpty)
          ...
          DimensionRowsList(
            ...
            isRoundProduct: controller.selectedProduct?.isRound == true,
      ...
      children: [
        Expanded(
          child: OutlinedButton.icon(
            ...
            label: Text('+ Add Dimension (${controller.dimensionRows.length})'),
  ...
  Widget _buildAddItemsButton(AddQuoteController controller) {
    final validCount = controller.dimensionRows.where((r) => r.isValid).length;
    return SizedBox(
      width: double.infinity,
