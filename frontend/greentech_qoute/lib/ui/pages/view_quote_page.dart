...
class _ViewQuotePageState extends State<ViewQuotePage> {
  ...
  void initState() {
    ...
    // 1. Using API mode AND
    // 2. Items are empty AND  
    // 3. Quote ID looks like a database ID (numeric) not a local ID (timestamp)
    // Local IDs are timestamps (long numbers), API IDs are small integers
        ...
        child: Column(
          ...
          children: [
            ...
            SectionCard(
              ...
              child: Column(
                children: [
                  _buildInfoRow('Project', _quote.projectLocation,
                      isBold: true),
  ...
  List<Widget> _buildGroupedItems() {
    ...
    for (final entry in grouped.entries) {
      ...
      final sectionTotal =
          sectionItems.fold(0.0, (s, i) => s + i.total);
